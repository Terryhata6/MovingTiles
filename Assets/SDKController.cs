...
public class SDKController : Singleton<SDKController>
{
    ...
    {
        GameEvents.Instance.OnLevelStart += OnLevelStartEvent;
        GameEvents.Instance.OnLevelVictory += OnLevelCompleteEvent;
        GameEvents.Instance.OnLevelFailed += OnLevelFailedEvent;
    }
    #endregion
    #region FacebookSDK
